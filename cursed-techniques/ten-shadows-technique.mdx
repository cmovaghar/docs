...
## Shikigami Stat Blocs

### Gama (1 Cursed Energy)
*Medium Monstrosity (Shikigami), unaligned*

- **AC** 16 (Natural Armor)
- **HP** 77 (14d8 + 14)
- **Speed** 10 m., swim 15 m. 
- **Proficiency Bonus** +2
- **Initiative** +3 (13)

| | | MOD | SAVE || | | MOD | SAVE || | | MOD | SAVE |
|:--|:-:|:----:|:----:|-|:--|:-:|:----:|:----:|-|:--|:-:|:----:|:----:|
|**Str**| 14| +2 | +4 ||**Dex**| 16|  +3  |  +5  ||**Con**| 12| +1 | +3 |
|**Int**| 4 | -3 | -3 ||**Wis**| 14|  +2  |  +2  ||**Cha**| 8 | -1 | -1 |

- **Skills** Acrobatics +7
- **Senses** Passive Perception 12
- **Languages** Understand the summoner's languages, but can't speak
- **CR** 2 (450 XP)
...
***Cursed Weapons.*** This creature's weapon attacks are magical.

***Amphibious.*** The Gama can breathe air and water. 

***Standing Leap.*** The Gama's long jump is up to 6 meters and its high jump is up to 3 meters, with or without a running start. 

***Support Carry.*** When the Gama has a Medium-sized creature or smaller grappled or Tongue Grabbed, it may swallow the creature, granting the creature Full Cover within its mouth. During this time, Gama can only move.

#### Actions
***Tongue.*** *Melee Attack Roll:* +5, reach 6 m. *Hit* 10 (2d6 + 3) Bludgeoning damage and the target must roll either Athletics or Acrobatics against a DC 13. On a failure, the target is grappled. While grappled, the target is restrained, and the Gama cannot make Tongue Grab attacks against different targets. The creature can attempt to escape the grapple by making a Strength or Dexterity saving throw (DC 13) as an action. On a success, the creature escapes the grapple.

***Tongue Slam.*** While the Gama has a creature grappled, it can slam them into a point within 10 meters, as long as that point has a solid surface or object of equal size to the creature. The grappled creature takes falling damage as if they had fallen the full distance they were thrown.

***Swallow.*** The Gama makes one Tongue Attack against a Medium or smaller creature it is grappling. On a hit, the target is swallowed, and the grapple ends. The swallowed creature is blinded and restrained, has total cover against attacks and other effects outside the Gama, and takes 10 (3d6) Acid damage at the start of each of the Gama's turns. The Gama can have only one target swallowed at a time.

If the Gama dies, any swallowed creature is no longer restrained and can escape from the corpse using 1 meter of movement, exiting prone.

The Gama can choose to partially swallow a creature. If partially swallowed, the creature is not blinded and does not take Acid damage.

#### Reactions
***Tongue Grab.*** *Trigger:* When an ally within 10 meters of Gamma would make a saving throw or take damage. *Response:* Gama uses its tongue to grab the ally, pulling them to a space next to the Toad. This causes the attack to miss or all damage and effects to be avoided, as long as the Toad is outside the area of effect.

***Projectile Interception.*** *Trigger:* When a ranged attack targets Gama, an ally or the summoner within 20 meters. *Response:* Gama intercepts the attack with its tongue. It makes a contested melee attack roll against the attack roll. If Gama's roll is higher, Gama catches it with its tongue and can either drop it or hold onto it. This cannot be used against Cursed Energy attacks. The attack must be a projectile.

### Rabbit Escape (2 Cursed Energy)
*Gargantuan Swarm of Tiny Monstrosities (Shikigami), unaligned*

- **AC** 11
- **HP** 588 (56d20)
- **Speed** 12 m., burrow 1 m.
- **Proficiency Bonus** +2
- **Initiative** +1 (11)

| | | MOD | SAVE || | | MOD | SAVE || | | MOD | SAVE |
|:--|:-:|:----:|:----:|-|:--|:-:|:----:|:----:|-|:--|:-:|:----:|:----:|
|**Str**| 1| -5 | -5 ||**Dex**| 13|  +1  |  +1  ||**Con**| 10| +0 | +0 |
|**Int**| 2 | -4 | -4 ||**Wis**| 10|  +0  |  +0  ||**Cha**| 3 | -4 | -4 |

- **Skills** Perception +2, Stealth +3
- **Immunities** Grappled, Frightened, Stunned, Prone, Charmed, Restrained, Paralyzed, Petrified
- **Senses** Passive Perception 12
- **Languages** None
- **CR** 0 (10 XP)
...
***Swarm.*** By using all of Rabbit Escape's movement, you can command the rabbits to swarm an area within 1 meter of them. The rabbits occupy an 8-meter area. They can occupy another creature’s space and vice versa, and can move through any opening large enough for a Tiny rabbit. The rabbits cannot regain hit points, except through the Never Ending feature, and they cannot gain temporary hit points.

***Neverending.*** When Rabbit Escape is de-summoned, its hit points immediately reset to their maximum.

***Crowd Control Vulnerability.*** The Rabbit Escape has disadvantage on saving throws against effects that cover an area, such as a cone, circle, or line. Additionally, any damage dealt to the swarm by such effects is tripled if the entire swarm is covered by the area of effect.

#### Actions
***Bite.*** *Melee Attack Roll:* +3, reach 1 m. *Hit* 3 (1d4+1) Piercing damage.

***Kick.*** *Melee Attack Roll:* +3, reach 1 m. *Hit* 3 (1d4+1) Piercing damage.

### Divine Dog (2 Cursed Energy)
*Medium Monstrosity (Shikigami), unaligned*
...
| | | MOD | SAVE || | | MOD | SAVE || | | MOD | SAVE |
|:--|:-:|:----:|:----:|-|:--|:-:|:----:|:----:|-|:--|:-:|:----:|:----:|
|**Str**| 17| +3 | +5 ||**Dex**|15|+2|+4||**Con**|15|+2|+2|
|**Int**|5|-3|-3||**Wis**|13|+1|+1||**Cha**|10| +0|+2|


- **Skills** Athletics +5, Perception +3, Stealth +4
- **Immunities** Charmed, Frightened
- **Senses** Passive Perception 13
- **Languages** Understands its summoner's languages, but cannot speak.
- **CR** 1 (200 XP)
...
***Pack Tactics.*** The Divine Dog has advantage on an attack roll against a creature if at least one of the Divine dog's allies is within 1 meter of the creature and the ally isn't incapacitated. 

***Keen Hearing and Sight.*** The Divine Dog has advantage on Wisdom (Perception) checks that rely on hearing or sight.

#### Actions
***Multiattack.*** The Divine Dog makes two Bite attacks.

***Bite.*** *Melee Attack Roll:* +5, reach 1 m. *Hit* 6 (1d6+3) Piercing damage. The target must succeed on a DC 13 Strength saving throw or be knocked prone.
...
| | | MOD | SAVE || | | MOD | SAVE || | | MOD | SAVE |
|:--|:-:|:----:|:----:|-|:--|:-:|:----:|:----:|-|:--|:-:|:----:|:----:|
|**Str**| 14|   +2 |   +2 ||**Dex**| 16|  +3  |  +5  ||**Con**| 16|  +3  |  +5  |
|**Int**|  8|  --1 |  --1 ||**Wis**|13|  +1  |  +1 ||**Cha**|10|  +0  |  +0|
...
***Cursed Energy.*** Nue has cursed energy it can use to fuel it's abilities. Its cursed energy is 15 or double its summoner's level plus their Charisma modifier, whichever is higher. If the summoner has the *Immense Cursed Energy* feat, Nue's cursed energy is instead equal to its summoner's level plus twice their Charisma modifier plus their proficiency bonus, if its higher. All of it's cursed energy is replenished at the end of a long rest. 

***Cursed Energy Recovery.*** In combat, Nue regains 1 cursed energy at the start of it's turns.

***Flyby.*** Nue doesn't provoke opportunity attacks while flying. 

***Keen Hearing and Sight.*** Nue has advantage on Wisdom (Perception) checks that rely on hearing or sight. 

#### Actions
***Multiattack.*** Nue makes two attacks: one with its Wings and one with its Talon.

***Wings.*** *Melee Attack Roll:* +5, reach 1 m. *Hit* 6 (1d6+3) Bludgeoning damage + 3 (1d6) Lightning damage. Nue can spend 5 Cursed Energy to add 27 (5d10) Lightning damage to the roll, and force the target to make a DC 13 Constitution saving throw. On a success, they take half as much damage. On a failure, they are knocked prone and their movement becomes 0 until the end of their next turn. During that time, they also have disadvantage on Strength and Dexterity saving throws.

***Talon.*** *Melee Attack Roll:* +5, reach 1 m. *Hit* 6 (1d6+3) Slashing damage.

***Lightning Charge (3 Cursed Energy).*** Nue fires a bolt of lightning at a single target within 20 meters. The target must make a DC 13 Dexterity saving throw or take 15 (3d10) Lightning damage. On a success they take half as much damage. On a failure they are knocked prone and their movement becomes 0 until the end of their next turn. During that time, they also have disadvantage on Strength and Dexterity saving throws.

help me kaido me force à écrire du mardown i cant anymore